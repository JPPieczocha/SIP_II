...
const Search = ({ navigation }) => {
          ...
          <View style={styles.modalContainer}>
            ...
            <View style={styles.formContainer}>
              <View style={styles.formContainerItem}>
                ...
                >
                  <Text style={{color: colors.secondaryv2}}>{sugarFree ? "X" : ""}</Text>
                </TouchableOpacity>
              </View>
              ...
              <View style={styles.formContainerItem}>
                ...
                >
                  <Text style={{color: colors.secondaryv2}}>{taccFree ? "X" : ""}</Text>
                </TouchableOpacity>
              </View>
              ...
              <View style={styles.formContainerItem}>
                ...
                >
                  <Text style={{color: colors.secondaryv2}}>{lowCal ? "X" : ""}</Text>
                </TouchableOpacity>
              </View>
            </View>
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={[styles.headerTitle, {marginLeft: 10}]}>Recientes</Text>
