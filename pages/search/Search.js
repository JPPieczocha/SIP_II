...
import { Text, View, Image, TextInput, Modal, FlatList, TouchableOpacity, SafeAreaView, Platform} from 'react-native';
                ...
                <View style={styles.modalFilter}>
                    <View style={styles.modalContainer}>
                        <View style={styles.modalHeader}>
                            ...
                            <TouchableOpacity style={styles.exitModalButton}  onPress={()=>setShowFilter(false)}>
                        ...
                        <Text>¿Quieres algunos de estas comidas?</Text>
                        <View style={styles.formContainer}>
                            <TouchableOpacity style={styles.checkBox} onPress={() =>setSugarFree(!sugarFree)}>
                                <Text>{sugarFree ? 'X' : ''}</Text>
                            </TouchableOpacity>
                            
                            <TouchableOpacity style={styles.checkBox} onPress={() => setTaccFree(!taccFree)}>
                                <Text>{taccFree? 'X' : ''}</Text>
                            </TouchableOpacity> 
                            
                            <TouchableOpacity style={styles.checkBox} onPress={() => setLowCal(!lowCal)}>
                                <Text>{lowCal? 'X' : ''}</Text>
                            </TouchableOpacity>
                        </View>
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.mainIput}>
                <TextInput style={styles.input} placeholder={'Escriba aquí'} onChangeText={(text) => setSearchInput(text)} keyboardType={'default'}  onSubmitEditing={()=> console.log(searchInput)}></TextInput>
                <TouchableOpacity style={styles.iconFilter} onPress={()=>setShowFilter(true)}>
            ...
            <View style={styles.main}>
                ...
                renderItem={item => <FoodItem navigation={navigation} data={item.item}></FoodItem>}
                numColumns={2}
