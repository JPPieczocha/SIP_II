...
export default function Recipe({ navigation, route }) {
    ...
    const handlePatology = () => {
        if (info !== undefined){
            if (context.state.userData.Celiaquia == 1 && info.Celiquia == 0) return true;
            if (context.state.userData.Tipo1 == 1 && info.Tipo1 == 0) return true;
            if (context.state.userData.Tipo2 == 1 && info.Tipo2 == 0) return true;
            if (context.state.userData.Obesidad == 1 && info.Obesidad == 0) return true;
            return false;
        }
